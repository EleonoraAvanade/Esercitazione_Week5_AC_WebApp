...
namespace WebApplication_Week5_AC_Esercitazione
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<RistoranteContext>(
                options => options.UseSqlServer(@"Server=.\SQLEXPRESS;Database=RistoranteDb;Persist Security Info=False;Integrated Security=true;")
                );
